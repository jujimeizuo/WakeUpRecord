...
def make_pic_and_save(sentence):
    ...
    image_url_for_issue = f"https://github.com/jujimeizuo/WakeUpRecord/blob/master/images/{date_str}/{index}.jpeg?raw=true"
...
def main(github_token, repo_name, bing_cookie, weather_message, tele_token, tele_chat_id):
